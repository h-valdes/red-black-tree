...
@brief Print the information in a node with data type double
@param *pNode pointer of the node to be printed
*/
void print_double(Node_t *pNode);

/*
Function: print_long_double
@brief Print the information in a node with data type long double
@param *pNode pointer of the node to be printed
*/
...
/*
Function: RBT_new_double
@brief Wrapper around the generic constructur RBT_new for double type. 
It assigns an already defined print_double function
*/
RBT_t *RBT_new_double();

/*
Function: RBT_new_long_double
@brief Wrapper around the generic constructur RBT_new for long double type. 
It assigns an already defined print_long_double function
*/
...
@brief Helper function for delete and insert procedures. Rotate to the left a 
node in the tree respect to their parents.
@param *pRBT pointer of the tree
...
@brief Helper function for delete and insert procedures. Rotate to the right 
a node in the tree respect to their parents.
@param *pRBT pointer of the tree
@param *x pointer of the node to be rotated
*/
...
/*
Function: transplant
@brief Helper function for delete procedure. It transplants one node into
another and free it from its children.
@param *pRBT pointer of the tree
@param *x pointer to the node to be transplanted
*/
...
@brief Helper function of RBT_delete. Checks and fix if there are any broken 
rules of the tree.
@param *pRBT pointer of the tree
...
/*
Function: clear
@brief Helper function for RBT_destroy. Cleans recursively the nodes
@param *pRBT pointer of the tree
@param *pNode pointer of the node
*/
...
/*
Function: add_null
@brief Helper function for RBT_export_dot. Adds the null nodes lines into the 
the DOT File.
@param *pNode pointer of the node
...
@brief Helper function for RBT_export_dot. Adds every child of the current node 
and calls add_null if necesary.
@param *pRBT pointer of the tree
...
@brief Helper function for RBT_export_dot. Adds a new line in the DOT File 
